...
function AddAppointmentModal({ closeModal, isOpen, datas }) {
  ...
  return (
    <Modal
      ...
      isOpen={isOpen}
      title={datas?.title ? 'Edit Appointment' : 'New Customer Appointment'}
      width={'max-w-3xl'}
    >
      {open && (
      ...
      <div className="flex-colo gap-6">
          ...
          <div className="sm:col-span-10">
            <Input
              ...
              placeholder={
                datas?.title
                  ? datas.title
                  : 'Select User name will appear here'
              }
            />
          </div>
          <button
        ...
        <div className="grid sm:grid-cols-2 gap-4 w-full">
          <div className="flex w-full flex-col gap-3">
            <p className="text-black text-sm">User Service Appointments</p>
            <Select
        ...
        <div className="grid sm:grid-cols-2 gap-4 w-full">
          <div className="flex w-full flex-col gap-3">
            <p className="text-black text-sm">Admin</p>
            <Select
        ...
        <div className="flex-col flex gap-8 w-full">
          <p className="text-black text-sm">Share with user via</p>
