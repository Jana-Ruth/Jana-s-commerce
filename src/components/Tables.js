...
export function MedicineTable({ data, onEdit }) {
  ...
  return (
    <table className="table-auto w-full">
      <thead className="bg-dry rounded-md overflow-hidden">
        <tr>
          <th className="px-4 py-2 uppercase text-left text-xs font-medium tracking-wider">
            #Items
          </th>
          ...
          <th className="px-2 py-2 text-left text-xs font-medium tracking-wider">
            Total Price
          </th>
          <th className="px-4 py-2 text-left text-xs font-medium tracking-wider">
            Actions
      ...
      <tbody>
        {data.map((item, index) => (
          ...
          >
            ...
            <td className={`${tdclass} font-semibold`}>{item?.customerName}</td>

            <td className={tdclass}>
              <h4 className="text-sm font-medium">{item?.orderId}</h4>
            </td>
        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <td className={tdclass}>
              ...
              >
                {!item?.status ? "Out of Stock" : "Available"}
              </span>
            </td>
            <td className={tdclass}>
              <MenuSelect datas={DropDown1} item={item}>
...
// User table
export function UserTable({ data, functions, used }) {
              ...
              <span
                className={`py-1  px-4 ${
                  item.status === "Delivered"
                    ...
                    ? "bg-orange-500 text-orange-500"
                    : item.status === "Shipped" // Check for Shipped status before Cancelled
                    ? "bg-green-500 text-green-500" // Green for Shipped
  ...
  return (
    <table className="table-auto w-full">
      <thead className="bg-dry rounded-md overflow-hidden">
        <tr>
          <th className={thclass}>Date</th>
          <th className={thclass}>{doctor ? "User" : "Doctor"}</th>
          <th className={thclass}>Status</th>
