...
function Sidebar() {
  ...
  return (
    <div className="bg-white xl:shadow-lg py-6 px-4 xl:h-screen w-full border-r border-border flex flex-col">
      <Link to="/">
        <img
          src="/images/logo.png"
          alt="logo"
          className="h-14 ml-4 object-contain"
        />
      </Link>
      <div className="flex-col gap-2 mt-6 overflow-auto flex-grow">
