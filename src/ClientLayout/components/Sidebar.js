...
import { logout, setOnlineUser, setSocketConnection, setUserDetails } from '../../store/userSlice';
            ...
            <div className='h-[calc(100vh-65px)] overflow-x-hidden overflow-y-auto scrollbar'>
...

                {
                    allUser.map((conv,index)=>{
                        return (
                            <NavLink to={"/messages/"+conv?.userDetails?._id} key={conv?._id} className='flex items-center gap-2 py-3 px-2 border border-transparent hover:border-subMain rounded hover:bg-slate-100 cursor-pointer'>
                                <div>
                                    <Avatar
