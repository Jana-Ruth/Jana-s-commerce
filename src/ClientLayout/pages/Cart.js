...
const Cart = () => {
    ...
    const handlePayment = async()=>{
        ...
        console.log("process",process.env.REACT_APP_STRIPE_PUBLIC_KEY)
                        ...
                        <div className='mt-5 lg:mt-0 w-full max-w-sm'>
                        {
                            ...
                            <div className='h-36 bg-slate-200 border border-slate-300 animate-pulse'>
                                ...
                                <div className='h-36 bg-white'>
                                    <h2 className='text-black bg-white font-medium px-4 py-1'>Bill details</h2>
                                    <div className='flex items-center justify-between px-4 gap-2  text-lg text-slate-600'>
                                        <p>Quantity</p>
                                        <p>{totalQty}</p>
                                    </div>
                                    <div className='flex items-center justify-between px-4 gap-2  text-lg text-slate-600'>
                                    ...
                                    <div className='flex items-center justify-between px-4 gap-2 text-lg text-black'>
                                        <p>Total Price</p>
